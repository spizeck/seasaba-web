  ...
  return (
    ...
    >
      {/* aspect-ratio shell: 4/3 mobile → 2.4/1 lg. No max-h here — outer clips it.
          w-full is required: without a definite width, min-h clamps through the
          aspect ratio and inflates the shell to ~427px below 427px viewports. */}
      <div className="relative w-full aspect-[4/3] min-h-[320px] lg:aspect-[2.4/1] lg:min-h-[420px]">
        <Image
          src={src}
          alt={alt}
          fill
