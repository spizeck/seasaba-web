  ...
  return (
    <>
      ...
      <p className="text-base leading-relaxed text-muted-foreground">
        ...
        your vessel, how clearance works, and how to dive with us while you&apos;re here. However
        you arrive — from a cruising sailboat to a superyacht — Sea Saba knows how to make diving
        Saba work around your vessel and your schedule.
      </p>
      ...
      <section id={visitingYachtsAnchors.mooring} className="mt-14 scroll-mt-40">
        ...
        <p className="mt-4 text-sm text-muted-foreground">
          Moorings can&apos;t be reserved — by you or by us — and it&apos;s uncommon for every
          suitable visiting-yacht mooring to be taken, though availability always depends on the
          season. Larger yachts generally anchor in the designated anchorage areas, since the
          yacht moorings aren&apos;t designed for their size. If you want a current picture of
          what the moorings and conditions look like,{" "}
          ...
          — we&apos;re happy to share what we&apos;re seeing. Current fees and mooring details are
          published by the{" "}
        ...
        <p className="mt-4 text-sm text-muted-foreground">
          Worth knowing for the future: Saba&apos;s harbor infrastructure is expanding with the{" "}
          ...
          , now under construction. We&apos;ll update this guide as the new harbor&apos;s yacht
        ...
        >
          <div>
            ...
            <p className="mt-4 text-base leading-relaxed text-muted-foreground">
              ...
              Sea Saba&apos;s dive center at 66 Fort Bay Harbor sits close to both piers — even
              walking the full length of the harbor area takes about five minutes.
            </p>
            <p className="mt-3 text-base leading-relaxed text-muted-foreground">
              ...
              check in. If you&apos;re moving gear, we have flatbed trucks available to help
              shuttle equipment between the dock and the shop.
            </p>
            <p className="mt-3 text-base leading-relaxed text-muted-foreground">
              Reaching us by radio: Sea Saba monitors VHF channel 10 — the practical channel for
              contacting the shop and our boats. We also keep a watch on channel 16 alongside the
              Harbor Master and other vessels, but that&apos;s the harbor&apos;s calling and
              emergency channel, not ours — use 10 for Sea Saba.
            </p>
            <p className="mt-3 text-base leading-relaxed text-muted-foreground">
              Ashore and need to get online? We have an outdoor Wi-Fi access point at the Fort Bay
              office with an open guest network — join through the guest portal for roughly 12
              hours of access. It&apos;s meant for use while you&apos;re at or near the shop, not
              out on the moorings.
            </p>
          </div>
        </FeatureImage>
      ...
      <section id={visitingYachtsAnchors.diving} className="mt-14 scroll-mt-40">
        ...
        <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
          The easiest and most reliable way to dive with us is to leave the yacht on its mooring,
          dinghy into Fort Bay, and join one of our scheduled boats. Bring your gear straight to
          the dive center — we can store it for you between dive days — and being on shore means
          backup equipment is right there if anything gives you trouble. Our trips depart from
          and return to {OPERATIONS.harbor}, so there&apos;s no hotel pickup to coordinate:
          just be at the dive center about 30 minutes before the boat leaves. Rental equipment is
          available, a dive computer is required on every dive (rentals available), and groups
          stay small at a maximum of {OPERATIONS.maxRecreationalDiversPerGuide} divers per guide.
        </p>
        <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
          In some situations we may be able to arrange a pickup from your vessel for the later
          dives of the day — it&apos;s not practical for the first dive, and it depends on your
          position, the conditions, and the day&apos;s schedule. If that would make your visit
          easier, ask us in advance rather than counting on it.
        </p>
        <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
          After diving you&apos;re welcome on our normal scheduled shuttle into town, and we can
          help coordinate taxis when you need one outside that.
        </p>
        <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
          ...
          per diver, per dive — Marine Park and hyperbaric chamber — come through on your Sea
          Saba diving invoice. Mooring, yacht registration, and harbor fees are a separate
          matter, settled directly with the Marine Park and the Harbor Office. The full guide to
          our trips, certification fit, equipment, and park rules lives on the{" "}
        ...
        <div className="mt-5 rounded-lg border border-border/40 bg-muted/20 p-5">
          ...
          <ul className="mt-3 space-y-2.5 text-sm text-muted-foreground">
            ...
            <li className="flex items-start gap-2"><span className="text-primary">✓</span><span>Published pickup times are for hotel guests; from a yacht, simply be at the dive center about 30 minutes ahead of the boat&apos;s departure time.</span></li>
            <li className="flex items-start gap-2"><span className="text-primary">✓</span><span>When booking online, tell us your vessel&apos;s name in the booking notes — or <Link href="/contact?interest=visiting-yacht" className="font-medium text-primary hover:underline underline-offset-4">send us a quick note</Link> / <Link href={CONTACT.whatsappHref} target="_blank" rel="noopener noreferrer" className="font-medium text-primary hover:underline underline-offset-4">WhatsApp</Link> afterward — so we know you&apos;ll be meeting us at Fort Bay rather than waiting for hotel pickup. Cell service can be weak around Ladder Bay, so reaching out before you arrive is sensible.</span></li>
          </ul>
        </div>

        <p className="mt-4 text-sm text-muted-foreground">
          Thinking about diving independently from your own vessel? Independent diving isn&apos;t
          permitted in the Saba National Marine Park — all scuba diving must be done with one of
          Saba&apos;s licensed dive operators, as stated on the Marine Park&apos;s{" "}
        ...
        <ul className="mt-4 space-y-4 text-sm text-muted-foreground">
          <li className="flex items-start gap-3">
            ...
            <span>
              ...
              and the conditions — the normal private-charter idea, just arranged around your
              vessel&apos;s timetable.
            </span>
          </li>
          <li className="flex items-start gap-3">
            ...
            <span>
              ...
              planned diving needs — cylinders, weights, rental equipment, first-aid and oxygen —
              though many large yachts already carry substantial dive gear, in which case our
              guide may simply join with tanks and personal kit.
            </span>
          </li>
        </ul>
        <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
          For diving from a customer&apos;s tender, we&apos;ll confirm the tender and its safety
          equipment are appropriate before the diving plan is finalized — a suitable dive platform
          and ladder, first-aid kit, oxygen, ship-to-shore radio, and a dive flag. If anything is
          missing we can supply first-aid and oxygen equipment, including DAN combination kits.
          Pricing and arrangements are tailored, so tell us what you have aboard and what
          you&apos;re planning.
        </p>
        <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
      ...
      <section id={visitingYachtsAnchors.equipment} className="mt-14 scroll-mt-40">
        ...
        <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
          ...
          computers are available. Sea Saba fills its own cylinders — air and{" "}
          {OPERATIONS.nitroxBlend} Nitrox — for our trips, and certified Nitrox divers get
          complimentary Nitrox on qualifying dives.
        </p>
        <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
      ...
      <section id={visitingYachtsAnchors.conditions} className="mt-14 scroll-mt-40">
        ...
        <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
          A local pattern worth knowing: the prevailing winds are commonly from the northeast,
          which often leaves Ladder Bay relatively calm — though a north swell can make it very
          uncomfortable, and that same swell can wrap around toward Tent Bay. Other anchorage
          options around Fort Bay may work in calm conditions or particular wind directions.
          Where you moor or anchor stays a Harbor Master and Marine Park question, but{" "}
          <Link href="/contact?interest=visiting-yacht" className="font-medium text-primary hover:underline underline-offset-4">
            ask us
          </Link>{" "}
        ...
        <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
          ...
          rescheduling whenever we can, and would rather help reduce the stress than add to it.
          Our{" "}
      ...
      <section id={visitingYachtsAnchors.contact} className="mt-14 scroll-mt-40">
        ...
        <p className="mt-4 text-sm text-muted-foreground">
          For full vessel-agency assistance — clearance logistics and broader shore arrangements —
          we recommend{" "}
          <TrackedContactLink
          ...
          (+599 416 2299). For everything around the diving itself — taxis, restaurant and hiking
          suggestions, or coordination where practical — just ask us.
        </p>
      </section>
      ...
      <section className="mt-20 text-center">
        ...
        <p className="mt-3 text-base text-muted-foreground">
          From a cruising sailboat to a superyacht, we know how to make diving Saba work around
          your vessel and your schedule. Secure your spot and come see us at Fort Bay.
        </p>
